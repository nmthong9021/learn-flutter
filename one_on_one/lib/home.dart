...
import 'package:one_on_one/TutorDetail.dart';
...
import 'menu.dart';
import 'member.dart';
import 'TutorClass.dart';
import 'FilterTag.dart';
import 'ListTutorItem.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget _buildTutorList(){
    ...
    for (var tutor in _tutors) {
       listTutor.add(ListTutorItem(onTap: (){
         Navigator.of(context)
              .pushNamed(TutorDetail.routeName, arguments: _tutors[tutor.id].name);
       }, uri: tutor.uri, name: tutor.name, rate: tutor.rate, description: tutor.description, arrTitle: tutor.arrTitle));
    }
    return Column(
...
Column(
            ...
            children: <Widget>[
                ...
                //         itemCount: _tutors.length,//_members.length,
                //         itemBuilder: (BuildContext context, int position) {
                //           return _buildRow(position);
                //         },
